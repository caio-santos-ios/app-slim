export const LollipopChart = ({ data, periodo }: { data: any[], periodo: string }) => {
    ...
    const totalW = Math.max(380, paddingLeft + paddingRight + count * minSlotW);
    const totalH = chartH + paddingBottom + paddingTop;
    const slotW = (totalW - paddingLeft - paddingRight) / count;
    ...
    return (
        <div style={{ overflowX: 'auto', width: '100%' }}>
            ...
            >
                ...
                {/* Grid lines */}
                <line x1={paddingLeft} y1={paddingTop} x2={totalW - paddingRight} y2={paddingTop} stroke="#e2e8f0" strokeWidth={0.4} strokeDasharray="4 4" />
                <line x1={paddingLeft} y1={paddingTop + chartH * 0.33} x2={totalW - paddingRight} y2={paddingTop + chartH * 0.33} stroke="#e2e8f0" strokeWidth={0.4} strokeDasharray="4 4" />
                <line x1={paddingLeft} y1={paddingTop + chartH * 0.66} x2={totalW - paddingRight} y2={paddingTop + chartH * 0.66} stroke="#e2e8f0" strokeWidth={0.4} strokeDasharray="4 4" />
                <line x1={paddingLeft} y1={paddingTop + chartH} x2={totalW - paddingRight} y2={paddingTop + chartH} stroke="#e2e8f0" strokeWidth={0.5} />
